...
class StockArrivalTime(models.Model):
    ...
    move_id = fields.Many2one("stock.move", "Receipt Move", ondelete="restrict")

    picking_id = fields.Many2one(
        "stock.picking", "Receipt", related="move_id.picking_id", store=True
    )
    ...
    supplier_id = fields.Many2one(
        "res.partner", "Supplier", related="purchase_order_id.partner_id", store=True
    )
