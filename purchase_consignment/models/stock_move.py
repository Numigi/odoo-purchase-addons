...
class StockMove(models.Model):
    ...
    def _propagate_owner_from_purchase_order(self):
        ...
        self.move_line_ids.write({'owner_id': purchase_order.partner_id.commercial_partner_id.id})

    @api.multi
    def _action_assign(self):
        res = super()._action_assign()
        moves_with_consignment = self.filtered(lambda m: m.purchase_line_id.product_id.consignment)
